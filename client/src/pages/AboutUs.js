            ...
            <div className="max-w-4xl mx-auto">
                <Card style={{ padding: '60px 40px', md: { padding: '80px 60px' } }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                        ...
                        <h1 style={{ fontSize: 42, lineHeight: 1.1, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 32 }}>
                        ...
                        <div style={{ color: theme.textSub, fontSize: 18, lineHeight: 1.8, maxWidth: 640 }}>
                            <p style={{ marginBottom: 24 }}>
                                ExamGen was born from a simple observation: <strong style={{ color: 'var(--text-primary)' }}>Academic logistics are unnecessarily hard.</strong>
                            ...
                            <div style={{ width: 80, height: 1, background: 'var(--border-subtle)', margin: '0 auto 40px' }} />

                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                <Icon name="chart" color={theme.accent} size={32} />
                                <h3 style={{ fontSize: 24, fontWeight: 700, color: 'var(--text-primary)', marginTop: 16, marginBottom: 12 }}>Our Mission</h3>
                                <p style={{ fontSize: 16 }}>
